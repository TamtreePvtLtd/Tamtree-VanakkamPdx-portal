        ...
        <Grid container spacing={2} display="flex" flexDirection="row" justifyContent="center" >
          <Grid item xs={12} sm={3.5}>
            ...
            >
              ...
              <a style={{color:"inherit",textDecoration:"none"}} href="tel:+15037472049"><p>Store No: +1 (503) 747-2049</p></a>
              <a style={{color:"inherit",textDecoration:"none"}} href="tel:+19714548476"><p> Ph No: +1 971-454-8476</p></a>
            </Typography>
          </Grid>
          {isMobile ? null : (
            <Divider orientation="vertical" flexItem style={{ backgroundColor: "#fff",height:"100px",alignSelf:"center",marginTop:"30px" }} />
          )}
          <Grid item xs={12} sm={3.5}>
            <Typography
              variant="body1"
