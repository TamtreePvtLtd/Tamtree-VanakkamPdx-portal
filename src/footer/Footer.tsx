    ...
    <Box component="footer" style={{
      ...
      <Box display="flex" flexDirection="row" justifyContent="center">
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={4}>
            <Typography variant="body1" sx={{fontFamily:"Itim",fontSize:"20px",marginTop:3}}  component="p">Contact Us</Typography>
            <Box display="flex" justifyContent="center" marginTop={3}>
              <InstagramIcon style={{ width: '30px', height: '30px', margin: '0 5px' }} />
              <WhatsAppIcon style={{ width: '30px', height: '30px', margin: '0 5px' }} />
              <FacebookIcon style={{ width: '30px', height: '30px', margin: '0 5px' }} />
            </Box>
          </Grid>
        </Grid>
      </Box>
      <Typography variant="body1" component="p">CopyRights©2024. All rights reserved by VANNAKKAM PDX.</Typography>
    </Box>
  );
};
